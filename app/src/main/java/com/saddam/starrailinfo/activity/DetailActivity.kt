package com.saddam.starrailinfo.activity
...
class DetailActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        const val EXTRA_ELEMENTINFO = "extra_elementinfo"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tvCharElementinfo: TextView = findViewById(R.id.char_elementinfo)
        val tvCharAffil: TextView = findViewById(R.id.char_affiliation)
        val tvCharIntro: TextView = findViewById(R.id.char_bio)
        val tvCharPath: TextView = findViewById(R.id.char_path)
        ...
        val charElementinfo = intent.getStringExtra(EXTRA_ELEMENTINFO)
        val charAffil = intent.getStringExtra(EXTRA_AFFILIATION)
        val charIntro = intent.getStringExtra(EXTRA_INTRO)
        val charPath = intent.getStringExtra(EXTRA_PATH)
        ...
        tvCharElementinfo.text = charElementinfo
        tvCharAffil.text = charAffil
        tvCharIntro.text = charIntro
        tvCharPath.text = charPath
        ...
        shareButton.setOnClickListener {
            ...
            goShare.putExtra(Intent.EXTRA_TEXT, "Hey look at this Starrail Character: $charLink")
